...
public class RabbitMQConfig {
     ...
     */
    @Bean
    public Binding binding_finishaddchoose_media_processtask(@Qualifier("xc_learning_finishaddchoosecourse") Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
     ...
     */
    @Bean
    public Binding binding_addchoose_media_processtask(@Qualifier("xc_learning_addchoosecourse") Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
